...
Public Class DatabaseClass
    ...
    Dim c_Connection As New SqlConnection("Data Source=DESKTOP-FV3MKIT ;Initial Catalog=DB_WaterMonitoring;User ID=sa;Password=Nydyy14324")
    ...
    Public Function getdata(ByVal databaseTable As String) As DataTable
    ...
    'Public Function get_integerVal(ByVal dbTable As String, ByVal dbColumn As Integer, ByVal whereClause As String) As Integer
    ...
    '    c_Command = New SqlCommand("Select " & dbColumn & " from " & dbTable & " where " & whereClause, c_Connection)
    '    c_Command.CommandType = CommandType.Text
    '    stockCount = c_Command.ExecuteScalar
    '    c_Connection.Close()
